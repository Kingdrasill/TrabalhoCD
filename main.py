...
#     conn = sqlite3.connect("banco_geral.db")  # Abre a conexão uma vez
...
plotar_graficos.plot_gols_campeonatos("banco_geral.db",[("Campeonato Brasileiro", 2024),("Campeonato Brasileiro", 2023),("Campeonato Brasileiro", 2022),("Campeonato Brasileiro", 2021)],melhor_i)
